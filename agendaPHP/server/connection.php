...
class ConectorBD
{
    ...
    function crearUsuarios(){
        ...
        $correo_usr = 'pedro@mail.com';
        $password_usr_not_hashed = '123';
        $password_usr = password_hash($password_usr_not_hashed, PASSWORD_DEFAULT);
        $nombre_completo_usr = "Pedro Perez";
        $fecha_nacimiento_usr = "1977-02-20";
        $stmt->bind_param("ssss", $correo_usr, $password_usr, $nombre_completo_usr, $fecha_nacimiento_usr);
        $stmt->execute();
        $correo_usr = 'juan@mail.com';
        $password_usr_not_hashed = '1234';
        $password_usr = password_hash($password_usr_not_hashed, PASSWORD_DEFAULT);
        $nombre_completo_usr = "Juan Gonzalez";
        $fecha_nacimiento_usr = "1988-10-10";
        $stmt->execute();
        $correo_usr = 'jose@mail.com';
        $password_usr_not_hashed = '12345';
        $password_usr = password_hash($password_usr_not_hashed, PASSWORD_DEFAULT);
        $nombre_completo_usr = "Jose Garcia";
        $fecha_nacimiento_usr = "1969-04-13";
        $stmt->execute();
    }
